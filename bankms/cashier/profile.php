...
$cid=$_SESSION['cid'];
$sql="update tblcashier set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob, Address=:address where tblcashier.ID=:cid";
...
<head>
    ...
    <title>e-Banking | Cashier Profile</title>
                            ...
                            <div class="card shadow mb-6">
                                ...
                                <div class="card-body">
                                   <form class="user" method="post">
                                     <?php
$cid=$_SESSION['cid'];
$sql="SELECT * from  tblcashier where ID=:cid";
$query = $dbh -> prepare($sql);
$query->bindParam(':cid',$cid,PDO::PARAM_STR);
$query->execute();
