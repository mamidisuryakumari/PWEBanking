...
$ret="select tbltransaction.AccountNumber,tbltransaction.Status as amtsta,tbltransaction.Amount,tbltransaction.TransactionDate
tbltransaction.TransactionType from tbltransaction where tbltransaction.UserID =:uid";
...
<tr>
 ...
 <?php if($row->amtsta=="I") { ?> 
   <td><?php  echo "Initial Amount";?></td>
   <?php } if($row->amtsta=="C"){ ?>
    <td><?php  echo "Credited Amount";?></td>
    <?php } if($row->amtsta=="D"){ ?>
